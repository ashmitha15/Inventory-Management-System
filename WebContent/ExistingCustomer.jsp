...
<h2>Enter the transcation details of customer</h2>
  ...
  String area = null;
     ...
     if(prod_id!=null && quantity!=null ){
         if(prod_id!="" && quantity!="") {
              ...
              String queryString = "SELECT CUST_ID FROM Fall22_S001_12_CUSTOMER_CUST_PHONE_NO WHERE CUST_PHONE_NO = ?";
              
              pstatement = connection.prepareStatement(queryString);
              pstatement.setString(1,CUST_PHONE_NO);
