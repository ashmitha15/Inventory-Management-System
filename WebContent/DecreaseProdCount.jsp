...
<head>
<meta charset="UTF-8">
<title>Decrease Product count</title>
</head>
...
<form name="datepickeer" action="DecreaseProdCount.jsp" method="POST">
...
Class.forName("oracle.jdbc.driver.OracleDriver").newInstance();
           ...
           request.getRequestDispatcher("DecreaseProdCount.jsp").forward(request,
                   response);
           %>
           <%
         }
...
%>
<form action="DecreaseProdCount.jsp" method="post">
<table border="1" >
<h2>Least sold Product Details</h2>
